# Contributing to TicketBeast API

## Code of Conduct

This project is released with a [Contributor Code of Conduct](https://github.com/MontealegreLuis/ticketbeast-api/blob/main/CODE-OF-CONDUCT.md).
...
## Using TicketBeast API from a Git checkout

The following commands can be used to perform the initial checkout of API Problem:

```bash
git clone git://github.com/MontealegreLuis/ticketbeast-api.git
cd ticketbeast-api
```
...
Before opening a new ticket, please search through the [existing issues](https://github.com/MontealegreLuis/ticketbeast-api/issues).
